<div align="center">
  <img src="./assets/logo.svg" alt="GitComplier" width="80" height="80">
  <h1>GitComplier</h1>
  <p><b>A seamless, browser-based execution environment and code editor.</b></p>
</div>
...
| Feature | Description |
| :--- | :--- |
| **Execution Engine** | Instant code compilation and console output rendering. |
| **Workspace State** | Automatic preservation ensures unsubmitted code is never lost. |
| **Intelligent Editor** | Real-time syntax highlighting, line numbering, and formatting. |
| **Adaptive UI** | Dynamic dark and light themes in a clean, distraction-free layout. |
